...
<body class="bg-gray-200">
    <div class="scroll-to-top fixed z-10 bottom-5 right-5">
        <a href="#nav">
        <svg class="w-[40px] h-auto text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <ul
                        ...
                        <li class="pr-3">
                            <a href="buku_tamu.php"
                                class="block py-2 px-3 md:text-white text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Testimoni</a>
                        </li>
                    </ul>
                </div>
            </div>
