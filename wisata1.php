...
<div class="container mx-auto px-[100px]">
    ...
    <div class="bigcard grid justify-center">
        <img src="img/ijen.png" alt="" class="w-[1300px] h-[500px] rounded-lg">
                ...
                <div class="w-full bg-gray-50 dark:bg-gray-700">
                    ...
                    <div class="bg-white dark:bg-gray-800">
                        <div class="grid grid-cols-3">
                            ...
                            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                                <form action="proses_pemesanan.php" method="POST">
                                    <input type="hidden" name="nama" value="Ijen Tour">
                        ...
                        <div class="grid grid-cols-3">
                            ...
                            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                                <select id="input3" name="jumlah_kunjungan_kuliner" class="border-none appearance-none"
                                    onchange="calculateTotal()">
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                        ...
                        <div class="grid grid-cols-3">
                            ...
                            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                                <div>$<input type="text" class="border-none appearance-none" id="totalBill"
